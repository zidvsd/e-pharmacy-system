...
import epharmacysystem.ui.dialogs.AdminEditPrescriptionDialog;
 ...
 * @author Zid
 */
public class AdminPrescriptionsPanel extends javax.swing.JPanel {
    
    private TableRowSorter<DefaultTableModel> sorter;
    public AdminPrescriptionsPanel() {
    initComponents();
    loadPrescriptions();
    ...
    private void btnEditPrescriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditPrescriptionActionPerformed
      ...
      prescriptionsTable.getModel().getValueAt(modelRow, 0).toString();
        ...
        AdminEditPrescriptionDialog dialog = new AdminEditPrescriptionDialog(
